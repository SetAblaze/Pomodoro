...
import { AppInfo, AssistantAppState, AssistantSmartAppData, AssistantStartSmartSearch, VpsConfiguration, EmotionId, OriginalMessageType, SystemMessageDataType, CharacterId, AssistantBackgroundApp, AssistantCommand, HistoryMessages, ThemeColorName } from '../typings';
...
export declare const createAssistant: ({ getMeta, ...configuration }: VpsConfiguration & CreateAssistantDevOptions) => {
    ...
    changeSdkMeta: (nextSdkMeta: Partial<SdkMeta>) => void;
