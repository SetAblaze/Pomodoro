...
export declare type CellView = LeftRightCellView | TextCellView | ButtonCellView | ImageCellView | DetailsCellView | WeatherCellView | RightSideCellView | FlexibleImageCellView;
export declare type LeftView = SimpleLeftView | FastAnswerLeftView | FlexibleImageLeftRightCellView;
/**
 ...
 */
export declare type Color = 'solid_black' | 'solid_white' | 'solid_transparent' | 'solid_disabled' | 'solid_brand' | 'solid_warning' | 'solid_critical' | 'solid_action' | 'secondary' | 'liquid_60' | 'liquid_50' | 'liquid_40' | 'liquid_30' | 'liquid_20' | 'liquid_10';
 ...
 */
export declare type Typeface = 'headline1' | 'headline2' | 'headline3' | 'title1' | 'title2' | 'body1' | 'body2' | 'body3' | 'body_ai' | 'text1' | 'paragraphText1' | 'paragraphText2' | 'footnote1' | 'footnote2' | 'button1' | 'button2' | 'caption';
/**
...
export declare type RightView = DisclosureRightView | DetailRightView | RoundButtonCellView | TagCellView | FlexibleImageLeftRightCellView | RightCellArrayView;
/**
...
export interface AssistantCommand {
    command: SmartAppDataCommand | ActionCommand | CloseAppCommand | PermissionCommand | InvoiceCommand | SmartAppErrorCommand;
    [k: string]: unknown;
}
/**
