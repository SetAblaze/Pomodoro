import { M as MessageNames, d as __awaiter, e as __generator, p as proto, b as __assign, c as createNanoEvents, a as __rest, _ as __spreadArrays, f as createCommonjsModule, h as commonjsRequire, m as minimal, g as commonjsGlobal } from './typings-56926c74.js';
...
var createClient = function (protocol, provideMeta) {
    ...
    var sendMeta = function (sendSystemMessage, legacyMeta) {
        if (legacyMeta === void 0) { legacyMeta = false; }
        return __awaiter(void 0, void 0, void 0, function () {
            var meta, _a;
                    ...
                    case 3:
                        ...
                        if (typeof meta !== 'undefined') {
                            ...
                            sendSystemMessage({
                                ...
                                messageName: '',
                            }, false, { meta: convertFieldValuesToString(meta || {}) });
                        }
                        return [2 /*return*/];
                }
            });
...
var CONNECTION_TIMEOUT = 2100; // ms (Slow 3G)
var CONNECT_INTERVAL = 300; // ms
...
var createTransport = function (createWS) {
    ...
    var _a = createNanoEvents(), on = _a.on, emit = _a.emit;
    var connectionTimeoutId = -1;
    var connectTimeoutId = -1;
    var retries = 0;
    var status = 'closed';
    var webSocket;
    var close = function () {
    ...
    var sendMetaForPermissionRequest = function (requestMessageId, appInfo, items) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    meta = _b.sent();
                    client.sendData(data, 'SERVER_ACTION', __assign(__assign({}, meta), props));
                    return [2 /*return*/];
            }
        });
    }); };
